...
module.exports.signup=async function(req,res){
    ...
    try{
        ...
        const result=await User.create({email:req.body.email,password:hashedPassword,name:`${req.body.firstName} ${req.body.lastName}`,adharCard:req.body.adharCard,panCard:req.body.panCard});
